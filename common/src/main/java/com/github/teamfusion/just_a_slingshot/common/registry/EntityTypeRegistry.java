...
public class EntityTypeRegistry {
    ...
    public static final Supplier<EntityType<ThrownEyeOfEnder>> THROWN_EYE_OF_ENDER = create("thrown_eye_of_ender", EntityType.Builder.<ThrownEyeOfEnder>of(ThrownEyeOfEnder::new, MobCategory.MISC).sized(0.3F, 0.3F));
